...
Vlastní filtry se zobrazí jako záložky v horní části [seznamu závodů](/napoveda/stranka-zavody). Každý člen si může vytvořit libovolný počet filtrů podle svých potřeb.
