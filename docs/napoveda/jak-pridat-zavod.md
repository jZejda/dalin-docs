...
5. **ORIS ID**:small_orange_diamond: kliknutím na ikonu **lupy** :mag: jsou z ORISu načteny relevantní závody podle výše zvolených kritérií.
...
:tada: **Tímto je vše hotovo**. Pokud nechce správce závodů provádět další specifická nastavení k závodu, není potřeba další akce.
