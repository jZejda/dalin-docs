...
**V detailu je možné vidět:**
 ...
 - na spodní straně detailu závodu je vidět **žurnál přihlášek**. Přihlášení členové vidí kdo je přihlášen, v žurnálu je možné se i [odhlásit](jak-se-odhlasit-ze-zavodu.md).

-----

::: tip Přidat závod
Počínaje rolí Člen mají tito uživatelé možnost se [přihlásit na závod](jak-se-prihlasit-na-oris-zavod.md). Pokud nejsou data aktuální, je možné aktualizaci vyvolat ručně.
:::
